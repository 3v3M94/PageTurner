...
const DEFAULT_USERS = [
  ...
  { nom: 'nom', prenom: 'prenom', email: 'nom@email.com', motdepasse: 'nom2026!', role: 'client' }
];
...
function updateNavSession() {
  ...
  if (session) {
    ...
    navAuth.innerHTML = `
      <a href="${getBasePath()}content/connexion.html" class="btn-nav">Connexion</a>
      <a href="${getBasePath()}content/inscription.html" class="btn-nav btn-nav-primary">Inscription</a>
    `;
  }
}
